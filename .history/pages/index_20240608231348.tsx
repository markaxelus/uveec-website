          ...
          <div className="pt-20 mb-20 space-y-20 overflow-hidden sm:pt-32 sm:mb-32 sm:space-y-32 md:pt-40 md:mb-40 md:space-y-40">
            ...
            <section id="team">
              ...
              <div className="relative pt-10 xl:pt-0 mt-10 xl:mt-2">
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 md:px-8 lg:grid lg:grid-cols-12 lg:gap-8">
                  ...
                  <div className="mt-4 -mx-4 my-4 sm:mx-0 lg:mt-0 lg:col-span-7 xl:col-span-6">
